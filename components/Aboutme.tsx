  ...
  return (
    <div className='wrapper'>
      ...
      <div className='sm:text-lg tracking-wide flex flex-col gap-6'>
        <p>
        I am a dedicated third-semester university student diving into the world of programming languages, currently honing skills in Next.js and Tailwind CSS. Aspiring to excel and contribute significantly to the tech industry.
        </p>
